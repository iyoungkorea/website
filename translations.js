const translations = {
    ...
    KR: {
        ...
        welcome2Text: "영코리아㈜는 차량용 TVㅣ MONITORㅣCAMERAㅣ블랙박스ㅣ 네비게이션을 자체 연구, 개발, 생산하는 전문 업체입니다. 30년 경력의 전문가로 구성된 연구 개발팀은 최고의 성능과 품질을 위하여 혼신의 노력을 다하고 있으며 이로 말미암아 국내 및 해외 시장에서 품질과 기술력을 인정받아 바이어와 소비자로부터 호평을 받고 있는 회사입니다.",
        ...
        welcome4Title: "지속 가능한 파트너십과 책임감",
        welcome4Text: "영코리아는 단순한 제품 공급을 넘어 고객과의 신뢰를 기반으로 장기적인 파트너십을 구축해왔습니다. 지난 수십 년간 납품 후에도 안정적인 운영을 위해 꾸준히 사후 서비스를 제공하며 고객의 신뢰를 쌓아왔습니다. 이러한 경험은 저희가 품질과 책임감을 최우선으로 두고 있음을 보여주며, 앞으로도 고객의 비즈니스 성장을 함께 지원하는 든든한 동반자가 될 것입니다.",
        partnershiplink:"저희가 제공하는 OEM/ODM 파트너십 기회에 대해 더 알아보세요.",

        
        aboutTitle: "영코리아㈜ 소개",
        aboutTitle2: "국내외 시장을 선도하는 기업",
        aboutText: "영코리아㈜는 차량용 TV, 모니터, 카메라, 블랙박스, 내비게이션 시스템, 초음파센서, 등 첨단 차량 기술의 독자적인 연구, 개발, 제조에 전념하는 전문 기업입니다. 자동차 기술의 진보에 대한 확고한 의지를 바탕으로 설립된 당사는, 30년의 경험을 갖춘 전문가들로 구성된 연구개발팀을 통해 개발부터 생산까지 모든 과정에서 최고 수준의 성능과 품질을 보장합니다. 당사는 국내외 시장에서 그 기술력과 품질을 인정받아 고객과 바이어로부터 깊은 신뢰를 얻고 있습니다.",
        aboutText2: "전 세계에서 개최되는 전자 전시회 참가 (미국, 브라질, 인도, 한국, 일본, 홍콩, 중국 등)",
        aboutText3: "생산공정",
        
        
        productsTitle: "제품 소개",
        productsText: "영코리아는 운전자와 탑승자의 안전, 엔터테인먼트, 편의성을 향상시키기 위한 다양한 자동차 제품을 제공합니다. 당사의 제품군에는 차량용 TV, 모니터, 카메라, 내비게이션 시스템, 센서등이 포함되어 있으며, 모두 견고한 기술을 기반으로 개발되었습니다. 신뢰할 수 있는 보안 기능이나 고품질 차량용 인포테인먼트를 원하신다면, 당사의 제품이 고객의 기대를 넘어설 것입니다. 제품 카탈로그를 통해 귀하의 니즈에 맞는 최적의 솔루션을 확인해 보십시오.",
